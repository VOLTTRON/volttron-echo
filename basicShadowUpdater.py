...
def customShadowCallback_Update(payload, responseStatus, token):
	...
	if responseStatus == "accepted":
		...
		print("property: " + str(payloadDict["state"]["desired"]["HeatOverride"]))
		print("~~~~~~~~~~~~~~~~~~~~~~~\n\n")
...
#python basicShadowUpdater.py -e a375ucgaqhmgbf.iot.us-west-2.amazonaws.com -r aws-iot-rootCA.crt -w

#a375ucgaqhmgbf.iot.us-west-2.amazonaws.com/things/deviceShadowInstance/shadow
...
set_point = 0 # topic is PNNL/DEMO/M2000
while True:
	payload = {
		"state":
			{
				"desired":
					{
						"HeatOverride": set_point, #property
	...
	Bot.shadowUpdate(JSONPayload, customShadowCallback_Update, 5)# 5
	set_point += 1
	time.sleep(10) #2
